...
function Finish() {
  return (
    ...
    >
      ...
      <Link to='/proyectoFinal/BuscarPedido'><button className="btn btn-outline-warning" type="primary">Registro de Pedido Terminado</button></Link>
        <Routes>
                    <Route path='/proyectoFinal/Buscar' element={<Confirmacion />} />
                </Routes>
        </div>
